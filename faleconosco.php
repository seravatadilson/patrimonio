                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDrop">
                        ...
                        <?php } else { ?>
                            ...
                            <a class="dropdown-item" href="painel.php">Servidores Cadastrados</a>
                            <a class="dropdown-item" href="painel.php">Lista de Siapes</a>
                        <?php }?>
                        <div class="dropdown-divider"></div>
...
<div class="content container">
    <h1>Contatos</h1>
    <p>Email: patrimonioicet@ufam.edu.br</p>
    <p>Setor localizado no bloco B (bloco Administrativo), térreo, sala .</p>
</div>
<!-- Rodapé -->
