...
function enviaEmail($solicitante,$email,$local_saida,$destino,$finalidade,$qtd_passageiro,$data)
{
    ...
    // Assunto do e-mail
    $mail->Subject = 'Reservas de Transporte';
    ...
    $mail->Body .= "Local de Saida: ".$local_saida."<br><p></p>";
    $mail->Body .= "Destino: ".$destino."<br><p></p>";
    $mail->Body .= "Finalidade: ".$finalidade."<br><p></p>";
    $mail->Body .= "Quantidade de Passageiro: ".$qtd_passageiro."<br><p></p>";
