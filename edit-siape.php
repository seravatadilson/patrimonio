...
$buscaSiape = buscaSiap($_GET['siape']);
$siape = array();

while ($r = mysqli_fetch_array($buscaSiape)) {
    $siape = $r;
}
            ...
            <div class="row">
                <div class="col-md-8">
                    <form id="edit-servidor">
                        <input type="hidden" class="form-control" id="serv" name="siap" value="<?php echo $siape['Siape_Servidor'] ?>">
                        <div class="form-group">
                            <label for="siape">Siape</label>
                            <input type="text" class="form-control" id="siape" name="siape" required="required" value="<?php echo $siape['Siape_Servidor'] ?>">
                        </div>
                        <div class="form-group">
                            <label for="siape">Nome Completo</label>
                            <input type="text" class="form-control" id="nome" name="nome" value="<?php echo $siape['Nome_Servidor'] ?>" required="required">
                        </div>
                        <div class="form-group">
                            <label for="siape">Cargo/Função</label>
                            <input type="text" class="form-control" id="cargo" name="cargo" value="<?php echo $siape['Cargo_Servidor'] ?>" required="required">
                        </div>
